...
def create_new_student():
    ...
    driver.find_element(By.ID, 'imageUpload').send_keys('C:/Users/Sveta/Desktop/WeGoStudyMain/upload/StudentImage.png')
    sleep(0.5)
    ...
    # __________________________Contact Information_________________________________
        ...
        sleep(0.5)
        driver.find_element(By.ID, 'user_student_detail_attributes_documents_attributes_0_file').send_keys('C:/Users/Sveta/Desktop/WeGoStudyMain/upload/TestDocument_1.pdf')
        sleep(0.5)
        driver.find_element(By.XPATH,
                            '//a[contains(@class,"btn btn-green-br ml-auto btn-xs mb-3 add_fields")]').click()
        sleep(0.5)
        driver.find_element(By.XPATH, '(//input[contains(@class, "form-control-file")])[2]').send_keys('C:/Users/Sveta/Desktop/WeGoStudyMain/upload/TestDocument_2.pdf')
        sleep(2)
